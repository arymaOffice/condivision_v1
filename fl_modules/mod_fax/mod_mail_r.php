    ...
    foreach($items as $k0 => $val0)
    {
      ...
      foreach($val0 as $k1 => $val1)
      {
	    ...
	    } else if (($k1=="disposition") && ($val1=="ATTACHMENT"))
        {
		 ...
		 (!isset($filenames)) ? $filenames = "filenames[]=$atch" : $filenames .= "&filenames[]=$atch";
       		$xf = 1;
	    } else if (!isset($xf) && ($k1=="subtype") && ($val1=="PDF"))
        {
...
if ($mail_or_link=="")
{
  ...
  echo "<p><a href=\"attach.php?conn_id=$conn_id&archivia=true&id=$var&$allegati_qu&$filenames\" class=\"button large\">Archivia Fax</a></p>";
