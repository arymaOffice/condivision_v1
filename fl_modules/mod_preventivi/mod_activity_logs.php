...
<a href="mod_opera.php?id=<?php echo $id; ?>&notanswered=1" class="touch orange_push setAction" data-gtx="<?php echo base64_encode($tab_id); ?>" data-id="<?php echo base64_encode($id); ?>" data-azione="2"  data-esito="3" data-note=""><i class="fa fa-hand-o-left"></i> <br>Rifiutato</a>
<a href="mod_opera.php?id=<?php echo $id; ?>&status_potential=3" class="touch red_push setAction" data-gtx="<?php echo base64_encode($tab_id); ?>" data-id="<?php echo base64_encode($id); ?>" data-azione="2"  data-esito="4" data-note="CAMPAGNA ID"><i class="fa fa-thumbs-down"></i> <br>A concorrenza</a>
<a href="<?php echo ROOT.$cp_admin; ?>fl_modules/mod_anagrafica/mod_inserisci.php?id=1&j=<?php echo base64_encode($id); ?>" class="touch green_push setAction" data-gtx="<?php echo base64_encode($tab_id); ?>" data-id="<?php echo base64_encode($id); ?>" data-azione="6"  data-esito="5" data-note="Conversione Cliente"><i class="fa fa-check-square-o"></i> <br>Vendita</a>
