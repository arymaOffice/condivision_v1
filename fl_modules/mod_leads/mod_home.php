...
-->
	...
	<a href="#" style="padding: 8px 20px;"  class="button showMessage" >Esporta i risultati correnti in excel</a> </p>
<form method="get">
      

      <?php if(isset($_GET['all'])) echo '<input type="hidden" name="all" value="1" />'; ?>
...
<a style="margin:10px 40%;" href="#"  class="button showMessage" >Esporta i risultati correnti in excel</a>
...
$(document).on('click','.showMessage',function(e){
	e.preventDefault();
	$.get('mod_export.php?'+ window.location.search.substring(1))
	alert('L\'esportazione è stata presa in carico e vi sarà recapitata per email non appena disponibile.' );
});
</script>
