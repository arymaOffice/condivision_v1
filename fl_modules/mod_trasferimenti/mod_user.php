...
<?php
	...
	while ($riga = mysql_fetch_array($risultato)) 
	{
			...
			$file_id = "<a data-fancybox-type=\"iframe\" class=\"fancybox\" href=\"../mod_dms/uploader.php?PiD=".$dmsFolder."&workflow_id=$tab_id&record_id=".$riga['id']."&NAme[]=Carta di Identita&NAme[]=Codice Fiscale&NAme[]=Documento Trasferimento\" title=\"Carica File\"><i class=\"fa fa-cloud-upload\"></i></a>"; 
			} else { 
			$elimina_id = ""; 
			$modifica_id = ""; 
			$file_id = ""; 
