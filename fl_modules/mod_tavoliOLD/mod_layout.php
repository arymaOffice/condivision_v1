	...
	<body style=" background: rgb(241, 241, 241) none repeat scroll 0% 0%;">
		<div id="container" >
			<div id="content_scheda" style="max-width:60%">
				...
				<!-- div canvas -->
				<div style="position:relative; width: 100%; margin: 0 auto; text-align:center; height:297mm;">			
					<canvas id="disposizioneTavoli" style="border: 1px solid grey;position:absolute;min-height:297mm;min-width:210mm;width:210mm;height:297mm;"></canvas>
				...
				<div id="dialog-form" title="Gestione tavolo" style="z-index: 1000;background: white;max-height:600px;text-align: left; display: hidden;">
					...
					<select id="catTable" style="padding-top: 11px;width: 30%;margin-left:7px">
						...
						<button id="delTable" class="button" style="color:#cb2c2c; background: none;margin-left:7px">Elimina tavolo</button>
