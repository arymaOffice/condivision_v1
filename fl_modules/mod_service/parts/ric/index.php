...
echo '<h1  style="text-align: center; padding: 50px; background: #008233; ">NUMERO VALIDO: <br><span style="font-size: 200%;"> '.base64_decode($userCode).'</span></h1>';
echo '<h1  style="text-align: center; margin-top: 20px; ">
<a data-fancybox-type="iframe" class="fancybox_view button" href="../mod_ricevute/?prescontrino=1&'.$results.'" style="width: 100%; padding: 17px;"><i class="fa fa-print" style="font-size: larger; color: white;"></i> STAMPA PRESCONTRINO </a>
</h1>';
echo '<div class="action"><p><a id="confirm" class="big-button green" href="./conferma.php?OrigId='.$data->OrigId.'&Time='.$data->Time.'&'.$results.'">Conferma</a></p></div>';
//echo '<h1>'.$data->payment.'</h1>';<a id="annulla" class="button red button_height" href="./conferma.php?annulla=1&OrigId='.$data->OrigId.'&Time='.$data->Time.'">Annulla</a>

} else { 

echo '<h1  style="font-size: larger; padding: 50px;
background: #B00002; margin-top: 20%; text-transform: uppercase; text-align: center;">'.$data->RcDs.'</h1>';
echo '<div class="action"><p><a id="confirm" class="big-button orange"  href="index.php">ESEGUI ALTRA OPERAZIONE</a></p></div>';
