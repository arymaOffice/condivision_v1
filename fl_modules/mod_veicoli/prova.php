...
set_time_limit(999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999);
...
// $select = "SELECT id,codice FROm fl_marca_eurotax WHERE id IN(3,4,12,14,16,25,24,26,28,19,30,31,32,40,39,41,44,46,48,49,50,51,52,53,54,55,60,56,57,59,64,66,69,70,72,73,76,80,84,86,90,92,93,97,99,100,98,101,104,107,112) ";
    $select = "SELECT id,codice FROm fl_marca_eurotax WHERE id IN(12,14,16,25,24,26,28,19,30,31,32,40,39,41,44,46,48,49,50,51,52,53,54,55,60,56,57,59,64,66,69,70,72,73,76,80,84,86,90,92,93,97,99,100,98,101,104,107,112) ";
