...
console.log($('#data_vendita').val());

$(document).ready(function() {


if($('#data_vendita').val() == '00/00/0000') {

	$('#metodo_pagamento').prop('disabled','true');
	$('#data_incasso').prop('disabled','true');
	$('#fattura_emessa').prop('disabled','true');
	$('#data_attivazione').prop('disabled','true');
	
	$('#box_metodo_pagamento').hide();
	$('#box_data_incasso').hide();
	$('#box_fattura_emessa').hide();
	$('#box_data_attivazione').hide();
...
$('#data_vendita').focusout(function( event ) {
	...
	$('#metodo_pagamento').removeAttr('disabled');
	$('#data_incasso').removeAttr('disabled');
	$('#fattura_emessa').removeAttr('disabled');
	$('#data_attivazione').removeAttr('disabled');
 	
 	
	$('#box_metodo_pagamento').show();
	$('#box_data_incasso').show();
	$('#box_fattura_emessa').show();
	$('#box_data_attivazione').show();
