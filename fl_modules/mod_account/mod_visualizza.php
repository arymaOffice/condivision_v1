...
<div id="container" <?php if (isset($_GET['external'])) {
...
<input name="password1" id="password1" type="password"  size="40" maxlength="30" />
</div></div>

<div class="form_row">
<div class="input_text">
<label for="password2">Conferma Password: </label>
<input name="password2" id="password2" type="password"  size="40" maxlength="30" />
</div></div>
<br>
<input type="hidden" name="modifica_pass" value="<?php echo check($_GET['id']); ?>">
<input type="submit" class="button" style="float:right;margin-right:15px;" value="Imposta manualmente password" />
</form>
</div>
