...
<?php if(isset($_GET['status_preventivo'])) { $status_preventivo = check($_GET['status_preventivo']);  ?>
<input type="hidden" name="status_preventivo" value="<?php echo $status_preventivo; ?>" />
<?php } ?>
