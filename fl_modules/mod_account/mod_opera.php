...
//header("Location: ./?success&esito=Nuovo Utente Creato e Mail inviata correttamente!&indietro=1");
                echo json_encode(array('action' => 'goto', 'class' => 'green', 'url' => check(@$_POST['reload']) . $creaAnagrafica . '&esito=Nuovo utente Creato&success', 'esito' => "Nuovo Utente Creato e Mail inviata correttamente!"));
                mysql_close(CONNECT);
                exit;

            } else {
//header("Location: ./?success&esito=Nuovo Utente Creato e Recapito e-Mail fallito!&indietro=1");
                echo json_encode(array('action' => 'goto', 'class' => 'green', 'url' => check(@$_POST['reload']) . $creaAnagrafica . '&esito=Nuovo utente Creato&success', 'esito' => "Nuovo Utente Creato. Recapito e-Mail fallito."));
                mysql_close(CONNECT);
                exit;
            }
