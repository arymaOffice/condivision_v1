<?php 
	...
	$checkbox = array('disposizione_tavoli','stato_evento','fiori','gruppo_musicale');
	$file = array();
	$timer = array();
	...
	*/
	...
	$menu = array('Agenda'=>'../mod_eventi/?','Planning'=>'../mod_eventi/?action=24&closed','Menù Planner'=>'../mod_eventi/?action=24&closed&definizioneMenu','Conteggio Ospiti'=>'../mod_eventi/?action=24&closed&totaleOspiti');
	...
	if(isset($_GET['definizioneMenu']))  $module_title .= ' - Definizione dei Menù';
