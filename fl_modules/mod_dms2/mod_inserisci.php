...
if(base64_decode(check($_GET['AiD'])) > 11 || $folder_info['proprietario'] == $_SESSION['number']) echo " | <a href=\"../mod_basic/action_elimina.php?gtx=$tab_id&amp;unset=".$id."&POST_BACK_PAGE\" title=\"Elimina\"  onclick=\"return conferma_del();\"><i class=\"fa fa-trash-o\"></i> Elimina </a>"; ?>
