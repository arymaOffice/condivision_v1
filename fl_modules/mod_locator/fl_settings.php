<?php 
	...
	$module_menu = '
	 ...
	 <ul>
      ...
      <li class=""><a href="./">Registro <span class="subcolor">Commissioni</span></a>      </li>
     </ul>';
	...
	if(isset($_GET['status_fatturazione']) && check(@$_GET['status_fatturazione']) >= 0) { $status_fatturazione_id = check($_GET['status_fatturazione']);  } else {    $status_fatturazione_id = -1; }
