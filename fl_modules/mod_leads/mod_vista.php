...
<?php if($status_potential_id != 4){ ?>
	...
	while ($riga = mysql_fetch_array($risultato)) 
	{
		...
		if($veicolo != NULL) $veicolo_lista = '<a href="../mod_veicoli/mod_inserisci.php?id='.$veicolo['id'].'">'.$veicolo['marca'].' '.$veicolo['modello'].'<br>'.$veicolo['anno_immatricolazione'].' Km. '.$veicolo['chilometri_percorsi'].'</a><br>'.@$alimentazione[$veicolo['alimentazione']].' TARGA: '.$veicolo['targa'].'';
