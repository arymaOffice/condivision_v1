...
if(check($_GET['id']) != 1) { 	$tab_div_labels = array('id'=>"Richiesta",'../mod_dms/uploader.php?PiD='.$dmsFolder.'&workflow_id='.$tab_id.'&NAme[]=Carta di Identita&NAme[]=Codice Fiscale&NAme[]=Documento Trasferimento&record_id=[*ID*]'=>'Documenti'); }
...
<?php if(check($_GET['id']) == 1) { ?><input type="hidden" name="reload" value="../mod_trasferimenti/mod_inserisci.php?t=<?php echo base64_encode('1'); ?>&id=" /><?php } ?>
