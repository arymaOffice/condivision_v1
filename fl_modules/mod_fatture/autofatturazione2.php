    ...
    <table class="dati"  style=" margin: 20px 0; width: 100%; border: #E4E4E4 1px solid; border-collapse: collapse" align="left">
       <tr>
		 ...
		 echo $mittente;
          ...
          <th scope="col" width="370" style="background: #ECECEC;">
...
<p><?php echo converti_txt($informazioni_cliente); ?></p>
  ...
  if(($dati['fattura_importi_zero'] == 0 && $totale_fattura > 0) || $dati['fattura_importi_zero'] == 1)
	...
	//mysql_query("UPDATE fl_config SET ultimo_periodo_inzio = '$periodo_inizio',ultimo_periodo_fine = '$periodo_fine' WHERE id = 2",CONNECT);
	mysql_close(CONNECT);
