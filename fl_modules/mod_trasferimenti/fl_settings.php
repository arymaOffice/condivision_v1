<?php 
	...
	$module_title = 'Trasferimento Utenti';
	$dmsFolder = base64_encode(FOLDER_TRASFERIMENTI);
	...
	$identificato = array('Non selezionato','In Attesa','Trasferito','Rifiutato','Archiviato');
