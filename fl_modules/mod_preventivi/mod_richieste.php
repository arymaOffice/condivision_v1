...
<a href="mod_richiesta.php?tipo_richiesta=2&status_preventivo=2&parent_id=<?php echo $parent_id; ?>"  data-fancybox-type="iframe" class="fancybox_small touch orange_push setAction" title="Imposta Follow Up"><i class="fa fa-calendar"></i> <br>Valuta</a>
<a href="mod_richiesta.php?tipo_richiesta=3&status_preventivo=3&parent_id=<?php echo $parent_id; ?>"  data-fancybox-type="iframe" class="fancybox_small touch red_push setAction" title="Registra Quotazione Rifiutata"><i class="fa fa-hand-o-left"></i> <br>Rifiutato</a>
<a href="mod_richiesta.php?tipo_richiesta=4&status_preventivo=5&parent_id=<?php echo $parent_id; ?>"  data-fancybox-type="iframe" class="fancybox_small touch red_push setAction" title="Registra Perdita"><i class="fa fa-thumbs-down"></i> <br>Concorrenza</a>
<!--<a href="mod_richiesta.php?tipo_richiesta=5&status_potential=&parent_id=<?php echo $parent_id; ?>"  data-fancybox-type="iframe" class="fancybox_small touch green_push setAction" title="Regitra Vittoria!"><i class="fa fa-check-square-o"></i> <br>Vendita</a>-->
...
<?php 
 ...
 <?php
	...
	?> 
      ...
      Scad. <?php echo mydate($riga['data_scadenza']); ?>
