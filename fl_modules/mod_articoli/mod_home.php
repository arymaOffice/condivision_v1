...
<table class="dati" summary="Dati">
  ...
  <?php 
	...
	if($riga['status_contenuto'] > 1) $colore = "class=\"tab_blue\"";
			...
			echo "<td>".@$categoria_id[@$riga['categoria_id']]."</td>";	
			echo "<td>Pubblicato<br>".mydate($riga['data_pubblicazione'])." da <a href=\"./?operatore=".$riga['operatore']."\">".@$proprietario[$riga['operatore']]."</a></td>";
