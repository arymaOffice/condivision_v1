...
Le ricordiamo che pu&oacute; accedere all'area riservata da qui: <a href=\"http://".ROOT.$cp_admin."\" title\"Area Riservata\">".ROOT.$cp_admin."</a>.<br /> </p>
...
if(isset($_POST['user'])) {
if(!preg_match('/^[A-Za-z0-9]{3,50}$/',$user)){
...
echo json_encode(array('action'=>'info','class'=>'red','url'=>'','esito'=>"Username Non valido. Deve contenere valori alfanumerici e deve essere di lunghezza tra 3 e 50 caratteri")); 
mysql_close(CONNECT);
exit;
}				
}
...
echo json_encode(array('action'=>'info','class'=>'red','url'=>'','esito'=>"La password deve contenere valori alfanumerici e deve essere di lunghezza tra 8 e 15 caratteri")); 
mysql_close(CONNECT);
exit;
}
...
<p>Puoi accedere al gestionale da qui: <a href=\"http://".ROOT.$cp_admin."\" title\"Area Riservata\">".ROOT.$cp_admin."</a>.<br /> </p>
