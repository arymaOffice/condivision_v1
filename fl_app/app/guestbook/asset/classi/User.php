...
//mysqli("localhost", "usr_matricloud", "w07Imz&1", "db_matrimonioincloud");

class User {
    private $dbHost     = "localhost";
    private $dbUsername = "usr_matricloud";
    private $dbPassword = "w07Imz&1";
    private $dbName     = "db_matrimonioincloud";
    private $userTbl    = 'cc_users';
