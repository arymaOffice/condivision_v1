...
<?php
  ...
  <th>Account</th>
	...
	{					
			...
			if($documenti_count > 2 && trim($riga['nome_e_cognome']) != "" && trim($riga['user']) != "" && trim($riga['codice_fiscale']) != "" ){
			...
			$files = "../mod_dms/uploader.php?PiD=".$dmsFolder."&workflow_id=$tab_id&record_id=".$riga['id'];
