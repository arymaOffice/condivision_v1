<?php 
	...
	$select = "user,srv,prodotto_id,COUNT(*) as totale, SUM(amount) as euro";
	$step = 1000; 
	$sezione_id = -1;
	$jorel = 0;
	$text_editor = 2;
	...
	$menuvoce = ($_SESSION['usertype'] == 0) ?  'Report  <span class="subcolor">Transazioni</span>' : 'Ricerca <span class="subcolor">Transazioni</span>';
	...
	$tipologia_main .= ricerca_avanzata('origID','origID');	
    ...
    $campo = (!isset($_GET['espandi'])) ? 'label' : 'label,valore_facciale';             
    $rif_operazione = $data_set->data_retriever('fl_sottoprodotti',$campo);
	$rif_operazione[0] = '';
