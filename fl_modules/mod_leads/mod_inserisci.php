...
-->
<a href="<?php echo ROOT.$cp_admin; ?>fl_modules/mod_eventi/?lead_id=<?php echo $potential['id']; ?>" class="touch green_push setAction" data-gtx="<?php echo base64_encode($tab_id); ?>" data-id="<?php echo base64_encode($potential['id']); ?>" data-azione="5"  data-esito="1"  data-note="Appuntamento"><i class="fa fa-calendar"></i> <br>Evento</a>
<a href="<?php echo ROOT.$cp_admin; ?>fl_modules/mod_appuntamenti/mod_user.php?j=<?php echo base64_encode($potential['id']); ?>" class="touch blue_push setAction" data-gtx="<?php echo base64_encode($tab_id); ?>" data-id="<?php echo base64_encode($potential['id']); ?>" data-azione="5"  data-esito="1"  data-note="Appuntamento"><i class="fa fa-calendar"></i> <br>Appuntamento</a>
<a href="<?php echo ROOT.$cp_admin; ?>fl_modules/mod_modelli/mod_catalogo.php?tipo_modello=1&POiD=<?php echo base64_encode($potential['id']); ?>&id=1" class="touch orange_push setAction" data-gtx="<?php echo base64_encode($tab_id); ?>" data-id="<?php echo base64_encode($potential['id']); ?>" data-azione="7"  data-esito="1"  data-note="Preventivo"><i class="fa fa-pencil-square-o"></i> <br>Crea Preventivo</a>
<!--<a href="mod_richiesta.php?tipo_richiesta=0&parent_id=<?php echo $potential['id']; ?>" title="Registra Chiamata" data-fancybox-type="iframe" class="fancybox_small touch blue_push"><i class="fa fa-phone"></i> <br>Call</a>
...
<a href="mod_richiesta.php?tipo_richiesta=0&parent_id=<?php echo $potential['id']; ?>" title="Registra Chiamata" data-fancybox-type="iframe"  class="fancybox_small touch blue_push"><i class="fa fa-phone"></i> <br>Call</a>
<a href="mod_invia_mail.php<?php echo "?".$_SERVER['QUERY_STRING']; ?>" title="Registra Invio Email" data-fancybox-type="iframe"  class="fancybox_view_medium touch blue_push"><i class="fa fa-envelope"></i> <br>Invia Mail</a>
