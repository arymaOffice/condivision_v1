...
if(isset($newid)) { $id = (is_numeric($newid)) ? check($newid) : exit; $where = "WHERE id = $id ";}	
	...
	$campi_today = array('data_preventivo','data_pubblicazione','data_visita','data_prenotazione','data_pagamento','data_richiesta','data_fattura','data_apertura','data_avvio','data_corrispettivo','data_versamento','data_scadenza_pec','data_sottoscrizione','data_inizio','data_fine','data_rinnovo','data_documento','data_operazione','data_scadenza');
