...
$(document).ready(function() {
  ...
  $('#box_privacy_1').find('label.labelbox').text('Promozioni riguardanti le varie tipologie di prodotti offerte da AUTHOS S.P.A');
  $('#box_privacy_2').find('label.labelbox').text('Promozioni più affini alle Sue preferenze ed abitudini');
  $('#box_privacy_3').find('label.labelbox').text('Promozioni commerciali relative a prodotti e servizi offerti da altre società');

  $('#box_privacy_1').find('.checkbox_container').width('30%');
  $('#box_privacy_2').find('.checkbox_container').width('30%');
  $('#box_privacy_3').find('.checkbox_container').width('30%');
