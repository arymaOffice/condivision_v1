...
if ($_GET['form']) {
    ...
    if (isset($params['n_monitor']) && isset($params['pollici'])) {
        ...
        mysql_query('INSERT INTO fl_data_link_mon (id_link,id_n_monitor,id_account) VALUES (' . $id . ',' . $params['n_monitor'] . ',' . $_SESSION['number'] . ')', CONNECT);
        ...
        //inserimento per statistiche numero monitor
        mysql_query('INSERT INTO fl_data_link_mon (id_link,id_n_monitor,id_account) VALUES (' . $id . ',1,' . $_SESSION['number'] . ')', CONNECT);
