<?php 
	...
	$checkRadioLabel = '<i class="fa fa-check-square"></i><i class="fa fa-square-o"></i>'; // Pulsante checkbox radio button Toggle apple
 	$tab_div_labels = array('id'=>"Prodotto di interesse",'data_vendita'=>"Dettagli Vendita",'note'=>'Note');
	...
	$status_vendita = array('Primo Contatto','Richiamare','Non interessato','Attività Conclusa');
	...
	$select = array('metodo_pagamento','metodo_di_pagamento',"alimentazione","proprietario",'tipologia_veicolo','pagamento_veicolo');
	$select_text = array();
	$disabled = array('data_acquisto','data_consegna','anno_immatricolazione','data_saldo','data_consegna',"data_creazione");
	$hidden = array('veicolo_id','assegnato_a',"data_creazione","data_aggiornamento","marchio","operatore");
	$radio = array();
	$text = array();
	$calendario = array('data_vendita','data_incasso','data_attivazione','data_contatto');	
	$file = array();
