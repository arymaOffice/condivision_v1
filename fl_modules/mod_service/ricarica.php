...
<br> <?php echo $riga['label']; ?> <?php echo numdec($riga['valore_facciale'],2); ?> &euro;
</h1>
...
-->
<p style="margin: 51px 0;">Inserisci numero di telefono</p>
<form id="form_ricariche" action="">
<input type="text" name="usercode" id="usercode" class="big-input">
</form>
<br><br>
<div class="action" id="indietro">
<p><a class="big-button red" href="index.php" id="annulla">Annulla</a></p>
</div>
<div id="printbox"></div>
</div>
...
<br>
<p id="loading" style="display: none; clear: both; text-align: center;"> ATTENDERE, Stiamo verificando il numero inserito.  <br><img src="../../fl_set/lay/preloader_oriz.png" alt="Caricamento in corso"/></p>
</div>

<div class="action"><p><a class="big-button green loadric unselectable" product="<?php echo $riga['id']; ?>" href="#" id="shaman">Procedi &gt;</a></p></div>
...
<div id="left_box" style="padding: 20px;"><h2>OPERAZIONE IN SOSPESO</h2><p>'.$_SESSION['product_label'].'</p>
	 <p><a id="confirm" class="big-button green" href="./conferma.php?'.$_SESSION['Results'].'">Conferma operazione</a></p>
     <p><a id="annulla" class="big-button red" href="./conferma.php?annulla=1&'.$_SESSION['Results'].'">Annulla operazione</a></p></div></div>';

} else { echo '<p><a class="big-button orange" href="index.php" style="width: 100%;">ESEGUI ALTRA OPERAZIONE</a></p>'; }
