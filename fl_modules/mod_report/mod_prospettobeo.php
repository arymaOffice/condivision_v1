...
$queryIntestazione = "SELECT e.id as id ,label as nome_ambiente,titolo_ricorrenza,(numero_adulti + numero_operatori) as sum_adulti ,numero_bambini FROM `fl_eventi_hrc` e JOIN fl_items a ON a.id = e.ambienti  WHERE stato_evento != 4 AND  DATE(`data_evento`) = '$data'";
