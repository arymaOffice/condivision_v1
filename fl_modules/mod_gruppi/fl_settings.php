<?php 
	...
	$tab_div_labels = array('id'=>"Gruppo",'./mod_synapsy.php?&workflow_id='.$tab_id.'&record_id=[*ID*]&connectId=85'=>'Iscritti');
	$connectId = 85;
    ...
    $persone = $data_set->data_retriever('fl_persone','nome,cognome','WHERE id != 1 AND (profilo_funzione = 8 OR profilo_funzione = 13)'); 
    unset($persone[0]);
    //i valori X2 della tabella X1
	$tipo_gruppo = array('Predefinito'); // Valori manuali (sconsigliato)
	...
	$select = array('tipo_gruppo','anagrafica_id');
	$disabled = array();
	$hidden = array('data_creazione','data_aggiornamento');
	$radio  = array('attivo');	
