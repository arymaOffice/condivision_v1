...
<div id="container">
  ...
  <p class="time"><?php echo $DATA; ?><br>
   <?php echo $merchant."-".$termID; ?></p><p><strong>TIM RICARICHE</strong></p>
</span>
...
<p align="center"><strong>NUMERO DI  TELEFONO</strong><br>
  ...
  <p>Con Ricarica 6euro+ il cliente  riceve 5 euro di traffico + 50 SMS verso tutti, da inviare entro 30 giorni. <br>
    Con Ricarica 12euro+ il cliente  riceve 10euro di traffico + 100 SMS verso tutti, da inviare entro 30 giorni. <br>
