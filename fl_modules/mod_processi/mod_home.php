...
<tr>
  <th style="width: 1%;"></th>
 <th><a href="./?ordine=1">Processo/Azienda</a></th>
  <th>Sedi Coinvolte</th>
...
<?php 
	...
	{					
			...
			echo "<tr>"; 
			$processo = ucfirst($riga['processo']);		
			echo "<td ><span class=\"Gletter\"></span></td>"; 
			echo "<td><span class=\"color\">$processo</span><br>".$anagrafica_id[$riga['anagrafica_id']]."</td>";
			echo "<td> $sedis </td>";
